...
public enum ValidationCode {
    ...
    HOUSE_NUMBER_NOT_STARTING_WITH_ONE(1, "House number should start with 1"), HOUSE_NUMBER_HAVE_DUPLICATE(2,
            "House number should not contains duplicates"), HOUSE_NUMBER_MISSING(3,
                    "House number cannot be missing bwteen start and end house number");
